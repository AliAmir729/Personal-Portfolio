...
const Navbar = () => {
  ...
  return (
    <nav className='flex flex-wrap justify-between md:items-center text-white px-10 pt-6 md:px-20'>
        <span className='text-xl md:text-3xl font-bold tracking-wide text-[#ff8c00] hover:text-[#ffdd57]'>Portfolio</span>
        <ul className={`${menu? "block" : "hidden"} mx-24 py-2 mt-4 font-semibold md:mt-5 bg-black px-2 rounded-xl bg-opacity-30 md:border-none text-center md:bg-transparent md:static md:mx-0 md:flex gap-6`}>
            ...
            <a href="#TechStack"><li className='text-md transition-all duration-300 p-1 md:p-0'>Tech Stack</li></a>
        ...
        {showMenu ?(
         ...
         size={30} className='color="white" md:hidden absolute right-10 top-6 transition-all duration-300' />}
